...
| ZIP/ZIP64 | seek or streaming, Store/Deflate/BZip2/Zstandard | streaming with descriptors (Zstandard write is native-codecs only) | optional WinZip AES; no Deflate64 or LZMA methods yet |
