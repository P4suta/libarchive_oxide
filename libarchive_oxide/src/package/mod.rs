...
//! whole-buffering them. It currently ships the Debian `.deb` profile via
//! [`DebValidator`]; the shared result vocabulary in [`finding`] is designed to
//! be reused by future package profiles and by CLI or JSON front ends.
